# 🛠️ Documentation technique - DaaS Orchestrator
...
└── ansible/
    ...
    ├── roles/
    │   ├── ad-join/              # Rôle jointure AD
    │   │   ├── tasks/main.yml
    │   │   └── templates/
    │   └── desktop-config/       # Rôle config desktop
    │       ├── tasks/main.yml
    │       └── templates/
    ...
    ├── group_vars/
    │   └── all/
    │       └── vault.yml         # Secrets Ansible (chiffrés)
    ├── ansible.cfg
...
### Structure recommandée (refactoring futur)
```python
orchestrator/
...
├── services/
│   ├── terraform.py        # Service Terraform
│   └── ansible.py          # Service Ansible
├── routes/
│   ├── api.py              # Routes API
...
**Pour toute question technique, consulter le code source ou contacter l'équipe DevOps.**
